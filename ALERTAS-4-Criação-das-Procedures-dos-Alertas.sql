...
BEGIN
	...
	-- Processo Bloqueado
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Processo Bloqueado')
...
BEGIN
	...
	-- Arquivo de Log Full
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Arquivo de Log Full')
...
BEGIN
	...
	--------------------------------------------------------------------------------------------------------------------------------
	-- Espaco Disco
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Espaco Disco')
			...
			*******************************************************************************************************************************/
			...
			SET @AlertaDiscoTable = CAST( (    
				...
				FROM (   
						...
						FROM [Monitoramento].[dbo].[_DTS_Espacodisco]
...
BEGIN
	...
	-- Consumo CPU
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Consumo CPU')
...
BEGIN
	...
	-- MaxSize Arquivo SQL
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'MaxSize Arquivo SQL')
			...
			SET @AlertaMDFLDFTable = CAST( (    
				...
				FROM (  
						...
						SELECT	DISTINCT 
								...
								[Growth]
						FROM [Monitoramento].[dbo].[_Resultado_Alerta_SQLFile]
						WHERE	(
									CASE WHEN [MaxSize(MB)] >= 150000 
...
BEGIN
	...
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Tempdb Utilizacao Arquivo MDF')
...
BEGIN
	...
	-- Conexões SQL Server
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Conexão SQL Server')
...
BEGIN
	...
	-- Página Corrompida
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Página Corrompida')
	...
	*******************************************************************************************************************************/
	...
	--------------------------------------------------------------------------------------------------------------------------------
	-- Status Database
	SELECT @Id_Alerta_Parametro = 8	-- SELECT * FROM [Monitoramento].[dbo].Alerta_Parametro
	...
	*******************************************************************************************************************************/	
	-- Status Database
	SELECT @Id_Alerta_Parametro = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Status Database')
...
BEGIN
	...
	-- Queries Demoradas
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Queries Demoradas')
...
BEGIN
	...
	-- Job Falha
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Job Falha')
...
BEGIN
	...
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'SQL Server Reiniciado')
...
BEGIN
	...
	-- Database Criada
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Database Criada')
...
BEGIN
	...
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Database sem Backup')
...
BEGIN
	...
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Banco de Dados Corrompido')
	...
	*******************************************************************************************************************************/
	IF EXISTS (SELECT NULL FROM [Monitoramento].[dbo].[_Result_Corrupcao]) 
	BEGIN	-- INICIO - ALERTA
		/*******************************************************************************************************************************
		--	CRIA O EMAIL - ALERTA
		*******************************************************************************************************************************/			
		...
		SET @AlertaBancoCorrompidoTable = CAST( (    
			...
			FROM (
					...
					SELECT	CONVERT(VARCHAR(20), [LogDate], 120) AS [LogDate],
							...
							[Erros],
							[Text]
					FROM [Monitoramento].[dbo].[_Result_Corrupcao]
...
BEGIN
	...
	DECLARE @Id_Alerta_Parametro INT = (SELECT Id_Alerta_Parametro FROM [Monitoramento].[dbo].Alerta_Parametro (NOLOCK) WHERE Nm_Alerta = 'Processos em Execução')
