...
AND			database_id > 6
AND			name NOT IN ('master_old','Monitoramento')
ORDER BY	name;
							...
							WHILE @@FETCH_STATUS = 0
								...
								BEGIN 
									...
									SET @cmd =	'EXEC sp_dropuser '''+@usr+''';'+CHAR(10)+
												...
												'GRANT SELECT, EXECUTE, VIEW DEFINITION TO ['+@usr+'];'+CHAR(10)+CHAR(10)+CHAR(10)
...
IF @@SERVERNAME = 'RDES05S\HOMOLOG'
	EXEC sp_addrolemember 'db_owner','INMETRO\wslima';